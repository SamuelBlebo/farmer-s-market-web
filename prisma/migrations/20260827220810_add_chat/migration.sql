...
-- CreateIndex
CREATE INDEX "Conversation_farmerId_lastMessageAt_idx" ON "Conversation"("farmerId", "lastMessageAt");

-- CreateIndex
CREATE UNIQUE INDEX "Conversation_buyerId_farmerId_key" ON "Conversation"("buyerId", "farmerId");
